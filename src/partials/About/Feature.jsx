...
import PlanetAvatar03 from '../../images/planet-avatar/3.png';
import PlanetAvatar04 from '../../images/planet-avatar/4.png';
import PlanetAvatar05 from '../../images/planet-avatar/5.png';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-200">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">开发全知视角</h1>
            <p className="text-xl text-gray-600">在日新月异的当下，我们对越来越多的事物有了更深层的多维认识。我们不断追求更广大的新视角以满足体验。我们将其称为开发全知视角的动因。这是让事物始终拥有生机的秘诀之一。</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:gap-16 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-5xl pt-8 md:pt-12">
            ...
            <div className="text-center">
              <div className="h3 mb-1">2019</div>
              <div className="text-gray-600">理念与组织在这一年中一同落地，<br />极客学园前身萌芽。</div>
            </div>

            {/* 2nd item */}
            <div className="text-center">
              <div className="h3 mb-1">6 / 3</div>
              <div className="text-gray-600">我们的产品 Solutioner&trade; 正在维护着六个项目，为三家公司提供正式服务。</div>
            </div>

            {/* 3rd item */}
            <div className="text-center">
              <div className="h3 mb-1">75+</div>
              <div className="text-gray-600">七十多个成员共同构建这个组织，GeekPara 与我们一同成长。</div>
            </div>
