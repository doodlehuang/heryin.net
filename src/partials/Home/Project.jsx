...
function FeaturesBlocks() {
  return (
    <section className="relative">
      ...
      <div className="absolute inset-0 top-1/2 md:mt-24 lg:mt-0 bg-red-900 pointer-events-none" aria-hidden="true"></div>
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">中州纪元</h4>
              <p className="text-gray-600 text-center">中州纪元是一款国风开放世界 RPG 型 Minecraft 基岩版多人服务器。也是和瑛社主营的项目。</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">MC 复原型场景设计</h4>
              <p className="text-gray-600 text-center">我们能够在 Minecraft 中复原现实中的场景、建筑、模型等，为古建筑保护、云旅游出一份力。</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">自媒体事业</h4>
              <p className="text-gray-600 text-center">我们运营自媒体账号，专注于产出高质量 Minecraft 实况、模组介绍、VR 视频等内容。</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">航测建模及制图</h4>
              <p className="text-gray-600 text-center">基于我们在 Minecraft 中还原场景的需求，我们衍生出了无人机航测、建模、制图等的业务。</p>
            </div>
              ...
              <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fillRule="evenodd">
                  ...
                  <g strokeWidth="2" strokeLinecap="square">
                    ...
                    <path className="stroke-current text-red-300" d="M44.571 43.429H34.286M44.571 37.714H34.286" />
                  </g>
                </g>
              </svg>
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">同城夜间饥饿感解除</h4>
              <p className="text-gray-600 text-center">基于普遍就寝时间延后造成的饥饿的问题，我们开创性的扩展了“吃饭”的时间范围，可提供夜间就餐指导。</p>
            </div>
